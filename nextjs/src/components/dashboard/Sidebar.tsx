...
export default function Sidebar() {
    ...
    <div className="app-sidebar">
            <a href="/dashboard" className="app-sidebar-container active">
            ...
            <a href="/timetable" className="app-sidebar-container">
            ...
            <a href="/settings" className="app-sidebar-container">
