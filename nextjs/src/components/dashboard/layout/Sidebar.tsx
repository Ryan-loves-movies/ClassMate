...
import styles from "@components/dashboard/layout/sidebar.module.css";
...
export default function Sidebar() {
    ...
    return (
        <div className={styles['app-sidebar']}>
            <Link href="/dashboard" className={`${styles['app-sidebar-container']} ${(pathName === "/dashboard" ? styles['active'] : "")}`}>
            ...
            <Link href="/timetable" className={`${styles['app-sidebar-container']} ${(pathName === "/timetable" ? styles['active'] : "")}`}>
            ...
            <Link href="/settings" className={`${styles['app-sidebar-container']} ${(pathName === "/settings" ? styles['active'] : "")}`}>
